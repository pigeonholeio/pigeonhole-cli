...
var initCmd = &cobra.Command{
	Use:   "init",
	Short: "Creates a default config file. This can be useful if you're using your own OIDC IdP",
...
You can update this to any OIdC provider that supports Device Authentication.
	`,
